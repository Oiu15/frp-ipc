        ...
        *,
        ...
        try:
            ...
            while True:
                ...
                if sample_id and (id_mm is None):
                    continue
            ...
            if sample_id and len(coords_id) < 3:
            ...
            try:
                ...
                self._last_sample_n_id = int(sum(1 for _p in (raw_points or []) if isinstance(_p, dict) and _p.get("id_mm", None) is not None))
