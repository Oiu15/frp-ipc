...
def build_gauge_screen(parent: ttk.Frame, *, presenter, controller, ui) -> None:
    ...
    ui.port_combo = ttk.Combobox(gbox, width=12, state='readonly', values=presenter.list_serial_ports())
    ui.port_combo.grid(row=0, column=2, padx=6, pady=6, sticky='w')
    ui.port_combo.set(DEFAULT_GAUGE_PORT)
    ...
    ui.req_cmd_combo = ttk.Combobox(gbox, width=10, textvariable=presenter.req_cmd_var, values=cmd_presets, state='normal')
    ui.req_cmd_combo.grid(row=0, column=7, padx=6, pady=6, sticky='w')
    ...
    ui.odcal_cmd_combo = ttk.Combobox(cbox, width=10, textvariable=presenter.odcal_cmd_var, values=cmd_presets, state='normal')
    ui.odcal_cmd_combo.grid(row=0, column=1, padx=6, pady=6, sticky='w')
    ...
    ui.odcal_out1_map_combo = ttk.Combobox(cbox, width=4, textvariable=presenter.odcal_map_out1_var, values=['L', 'R'], state='readonly')
    ui.odcal_out1_map_combo.grid(row=0, column=5, padx=6, pady=6, sticky='w')
    ...
    ui.odcal_angle_src_combo = ttk.Combobox(adv_frame, width=10, textvariable=presenter.odcal_angle_src_var, values=['AX3', '???'], state='readonly')
    ui.odcal_angle_src_combo.grid(row=0, column=1, padx=6, pady=4, sticky='w')
    ttk.Label(adv_frame, text='??/??').grid(row=0, column=2, padx=(10, 2), pady=4, sticky='e')
    ui.odcal_filter_combo = ttk.Combobox(adv_frame, width=10, textvariable=presenter.odcal_filter_var, values=['?', '??(3)', '??(5)'], state='readonly')
    ui.odcal_filter_combo.grid(row=0, column=3, padx=6, pady=4, sticky='w')
