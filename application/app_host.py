...
class AppHost(HostIdentityMixin, HostUIMixin, HostGaugeConnectionMixin, HostValidationMixin, HostAxisCalibrationMixin, HostControlMixin, HostExportMixin, tk.Tk):
