...
class AppHost(HostIdentityMixin, HostUIMixin, HostGaugeConnectionMixin, HostLengthMeasurementMixin, HostValidationMixin, HostAxisCalibrationMixin, HostControlMixin, HostExportMixin, tk.Tk):
